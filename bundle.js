	...
	var Board = React.createClass({
	  ...
	  generateColHints: function () {
	    ...
	    return ArrayHelpers.transpose(solutionGrid).map(function (col, idx) {
	      return React.createElement(
	        'div',
	        { className: 'col-hint-item', key: idx },
	      ...
	      this.props.board.playerGrid.map(function (row, i) {
	        return React.createElement(
	          ...
	          row.map(function (tile, j) {
	            return React.createElement(Tile, { updateGame: that.props.updateGame, ref: [i, j], tile: tile, key: j, background: '' });
	          })
	        );
	      }.bind(this))
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tile = React.createClass({
	  ...
	  render: function () {
	    return React.createElement("div", { onClick: this.handleLeftClick,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ArrayHelpers = __webpack_require__(163);
